...
COE is the instructor-side tool. It does not help students use AI (that is [COF](https://github.com/terrene-foundation/co-finance)). It helps instructors design teaching that remains valid when students have access to AI.
...
The AI will introduce itself, explain the five-phase workflow (Analyze, Plan, Execute, Review, Finalize), and ask about your course or assessment project. Answer in plain language. Describe what you are teaching, what you want to assess, and what concerns you have about AI use.
