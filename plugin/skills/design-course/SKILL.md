...
# /co-education:design-course $ARGUMENTS

Design the assessment architecture for **$ARGUMENTS**.

## Protocol

1. **Gather course information**: learning outcomes, credit points, student cohort size, delivery mode
2. **Design the assessment suite**: a set of assessments that collectively cover all learning outcomes
...
6. **Apply AI-resilience principles** to each assessment in the suite
