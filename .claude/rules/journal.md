...
Journal entries MUST use sequential naming: `NNNN-TYPE-topic.md` (e.g., `0001-DECISION-chose-assessment-model.md`, `0002-DISCOVERY-ai-resilience-pattern.md`). Before creating a new entry, MUST check the highest existing number in the journal directory.
...
|------|---------|-------------|
| **DECISION** | Record a choice with rationale, alternatives considered, and consequences | When making pedagogical, assessment, design, or scope decisions |
...
| **RISK** | Record an identified risk, vulnerability, or concern | When reviewing, auditing, or validating reveals potential problems |
