...
5. The Outstanding Ledger, reconciled per the two sections below
...
| F1 | rubric-alignment audit | brief.md goal 2; journal 0014 DECISION | queued |
...
| G1 | rubric-alignment audit | ... | queued | # F1 renamed to G1
