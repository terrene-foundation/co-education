...
1. **Read analysis outputs** from `01-analyze/` AND **read `specs/_index.md` plus relevant spec files** for domain truth. **If `specs/_index.md` does not exist, STOP — return to `/analyze` to create specs. Do NOT create specs during /plan.** See `rules/specs-authority.md`.
