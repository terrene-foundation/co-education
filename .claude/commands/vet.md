...
6. **Finalize** — once review passes, save the finalized output to `06-deliver/`

Once all critical and major issues are resolved, save the finalized work to `06-deliver/`.
